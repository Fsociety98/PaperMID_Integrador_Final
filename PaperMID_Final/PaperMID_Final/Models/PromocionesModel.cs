...
namespace PaperMID.Models
{
    public class PromocionesModel
    {
        ...
        public int Agregar(object Obj)
        {
            ...
            SqlCommand Cmd = new SqlCommand("INSERT INTO [dbo].[Promociones] ([NombrePromo],[DescripcionPromo],[DescuentoPromo],[FechaInicioPromo],[FechaFinPromo],[IdProveedor1],[FechaRegistroPromo],[StatusPromo]) VALUES (@NombrePromo,@DescripcionPromo,@DescuentoPromo,@FechaInicioPromo,@FechaFinPromo,@IdProveedor1,@FechaRegistroPromo,@StatusPromo);");
            Cmd.Parameters.Add("@NombrePromo", SqlDbType.VarChar).Value = oPo.NombrePromo;
            Cmd.Parameters.Add("@DescuentoPromo", SqlDbType.Float).Value = oPo.DescuentoPromo;
        ...
        public int Modificar(object Obj)
        {
            ...
            SqlCommand Cmd = new SqlCommand("Update [dbo].[Promociones] Set [NombrePromo]=(@NombrePromo), [DescripcionPromo]=(@DescripcionPromo),DescuentoPromo=(@DescuentoPromo),[FechaInicioPromo]=(@FechaInicioPromo),[FechaFinPromo]=(@FechaFinPromo),[IdProveedor1]=(@IdProveedor1) Where IdPromocion=@IdPromocion");
            ...
            Cmd.Parameters.Add("@DescuentoPromo", SqlDbType.Float).Value = Bo.DescuentoPromo;
        ...
        public PromocionesBO RecuperarPromo(int Id)
        {
            ...
            Promo.DescuentoPromo = Convert.ToDouble(Row["DescuentoPromo"].ToString());
            ...
            Promo.RangoPromo= Row["FechaInicioPromo"].ToString()+"-"+ Row["FechaFinPromo"].ToString();
